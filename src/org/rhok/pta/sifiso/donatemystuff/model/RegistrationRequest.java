...
/**
 * This is a Registration Request and it maps the JSON document the user will be
 * submitting for registration The class include a utility method for creating
 * its JSON format.
 * 
 * @author IMakitla
 * 
